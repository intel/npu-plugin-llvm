...
// these types are used for pipeline options that we manually pass to the
// constructor
...
struct SimplePassWithOptions
  ...
  SimplePassWithOptions(const SimplePassWithOptions &other)
      : PassWrapper(other) {}
  ...
  LogicalResult initialize(MLIRContext *ctx) final { return success(); }

  void runOnOperation() override {}

public:
  StrPassOpt strOpt{*this, "str-opt", ::llvm::cl::desc("string test option"),
                    llvm::cl::init("")};
  IntPassOpt intOpt{*this, "int-opt", ::llvm::cl::desc("int test option"),
                    llvm::cl::init(intOptDefaultVal)};
  BoolPassOpt boolOpt{*this, "bool-opt", ::llvm::cl::desc("bool test option"),
                      llvm::cl::init(boolOptDefaultVal)};
};
...
TEST(PassPipelineOptionsTest, CopyAllOptions) {
  struct DuplicatedOtions : ::mlir::PassPipelineOptions<DuplicatedOtions> {
    ...
    IntOption intOpt{*this, "int-opt", ::llvm::cl::desc("int test option"),
                     llvm::cl::init(intOptDefaultVal)};
    BoolOption boolOpt{*this, "bool-opt", ::llvm::cl::desc("bool test option"),
                       llvm::cl::init(boolOptDefaultVal)};
  };
...
TEST(PassPipelineOptionsTest, CopyMatchedOptions) {
  struct SomePipelineOptions
      : ::mlir::PassPipelineOptions<SomePipelineOptions> {
    StrOption strOpt{*this, "str-opt", ::llvm::cl::desc("string test option")};
    IntOption intOpt{*this, "int-opt", ::llvm::cl::desc("int test option")};
    StrOption anotherStrOpt{
        *this, "another-str-pipeline-opt",
        ::llvm::cl::desc("there is no such option in SimplePassWithOptions"),
        llvm::cl::init("anotherOptVal")};
    IntOption anotherIntOpt{
        *this, "another-int-pipeline-opt",
        ::llvm::cl::desc("there is no such option in SimplePassWithOptions"),
        llvm::cl::init(10)};
  };
